...
const PortableTextComponents: Partial<PortableTextReactComponents> = {
  ...
  block: {
    h1: ({ children }: { children?: React.ReactNode }) => (
      <h1 className="mb-10 text-6xl font-bold">{children}</h1>
    ),
    h2: ({ children }: { children?: React.ReactNode }) => (
      <h2 className="mb-10 text-5xl font-bold">{children}</h2>
    ),
    h3: ({ children }: { children?: React.ReactNode }) => (
      <h3 className="mb-9 text-4xl font-bold">{children}</h3>
    ),
    h4: ({ children }: { children?: React.ReactNode }) => (
      <h4 className="mb-9 text-3xl font-bold">{children}</h4>
    ),
    h5: ({ children }: { children?: React.ReactNode }) => (
      <h5 className="mb-8 text-2xl font-bold">{children}</h5>
    ),
    h6: ({ children }: { children?: React.ReactNode }) => (
      <h6 className="mb-8 text-xl font-bold">{children}</h6>
    ),
